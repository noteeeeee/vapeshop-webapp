 ...
 *
 * @checksum - 49eb1e42741a9dcd3d9e95a0ec7cbb80310183e8b3b9877cb237d2e592be66e6
 * @variables - radius=rounded-lg,accentColor=blue,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=700,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
 * @theme - regenesis
 **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:box__decorator": {
    ...
    "bg-white": true,
    "ring-blue-500": true,
    "peer-checked:border-2": true,
    "peer-checked:border-zinc-600": true,
    relative: true,
    block: true,
    "text-lg": true,
    "w-[1em]": true,
    ...
    "dark:peer-checked:text-black": true,
  },
  ...
  "family:text__inner": {
    ...
    "focus-within:border": true,
    "focus-within:border-white/70": true,
    "focus-within:ring-offset-2": true,
    "focus-within:!ring-secondary": true,
    "focus-within:!outline-white": true,
    ...
    "dark:group-data-[invalid]:ring-red-600": true,
  },
  "family:text__input": {
    "appearance-none": true,
    "[color-scheme:light]": true,
    ...
    "group-data-[disabled]:!cursor-not-allowed": true,
    "dark:placeholder-secondary/70": true,
    "dark:text-secondary": true,
    "border-none": true,
    "p-0": true,
    "focus:ring-0": true,
  ...
  "family:dropdown__listbox": {
    ...
    "group-data-[overscroll]:dark:border-neutral-700": true,
  },
  ...
  color__inner: {
    ...
    "dark:group-data-[prefix-icon]:border-neutral-700": true,
    "dark:group-data-[suffix-icon]:border-neutral-700": true,
  },
  color__input: {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  range__input: {
    ...
    "dark:[&::-webkit-slider-thumb]:group-data-[disabled]:!ring-neutral-700":
      true,
  ...
  submit__input: {
    ...
    "dark:disabled:bg-secondary/70": true,
    ...
    "!text-base": true,
    "!rounded-none": true,
    "hover:bg-secondary/90": true,
    "group-data-[loading=true]/form:before:content['']": true,
    "group-data-[loading=true]/form:before:white": true,
  ...
  autocomplete__selectionWrapper: {
    ...
    "dark:group-data-[multiple]:border-neutral-700": true,
  ...
  repeater__downControl: {
    ...
    "dark:text-secondary": true,
    "dark:disabled:!text-secondary": true,
    "dark:hover:text-blue-500": true,
  },
  repeater__upControl: {
    "w-[1.5em]": true,
  ...
  slider__minValue: {
    ...
    "dark:[&>div>div::after]:bg-neutral-700": true,
  },
  slider__maxValue: {
    grow: true,
    "!max-w-[45%]": true,
  ...
  "multi-step__tab": {
    ...
    'group-data-[tab-style="tab"]/wrapper:data-[active=true]:shadow-[0_0_0.5em_0_rgba(0,0,0,0.1)]':
      true,
    'dark:group-data-[tab-style="tab"]/wrapper:text-secondary': true,
    ...
    'dark:group-data-[tab-style="progress"]/wrapper:before:border-neutral-800':
      true,
    ...
    'dark:group-data-[tab-style="progress"]/wrapper:after:bg-neutral-800': true,
  ...
  "multi-step__tabLabel": {
    ...
    'dark:group-data-[tab-style="progress"]/wrapper:text-secondary': true,
  },
  "multi-step__badge": {
    "bg-red-600": true,
    absolute: true,
