 ...
 *
 * @checksum - e823f6540a932dc117cb0ed60fbec01155e881682a1a34d50942b003be009135
 * @variables - radius=rounded,accentColor=orange,colorTemperature=zinc,spacing=2,scale=base,inputShadow=shadow-none,baseColorShade=600,borderShadeLightMode=300,borderShadeDarkMode=500,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
 * @theme - regenesis
 **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:text__input": {
    ...
    "!placeholder-muted-foreground": true,
    "min-w-0": true,
    "min-h-[1.5em]": true,
    grow: true,
    "outline-none": true,
  ...
  "family:dropdown__listitem": {
    ...
    "dark:data-[is-active]:text-muted-foreground": true,
    "before:content-['']": true,
  ...
  "family:dropdown__tag": {
    ...
    "group-data-[active-selection=true]/tag:text-muted-foreground": true,
  },
  ...
  submit__input: {
    ...
    "group-data-[disabled]:!cursor-not-allowed": true,
    "disabled:border-zinc-100": true,
    "disabled:bg-zinc-500": true,
    "disabled:text-zinc-200": true,
  ...
  colorpicker__valueString: {
    ...
    "dark:selection:text-muted-foreground": true,
  },
  colorpicker__panel: {
    absolute: true,
    "left-0": true,
  ...
  colorpicker__fieldGroup: {
    ...
    "[&>input]:p-1": true,
    "[&>input]:text-sm": true,
    "[&>input]:text-muted-foreground": true,
  ...
  datepicker__month: {
    ...
    "focus:bg-white": true,
    "focus:text-muted-foreground": true,
  ...
  datepicker__dayCell: {
    ...
    "dark:focus:text-muted-foreground": true,
  },
  ...
  togglebuttons__input: {
    ...
    "group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-orange-500":
      true,
    "group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-orange-600":
      true,
    "group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-orange-600":
      true,
    "dark:group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-orange-600":
      true,
    "dark:group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-orange-600":
      true,
    "dark:group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-orange-600":
      true,
    ...
    "group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-orange-500":
      true,
    "group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-orange-600":
      true,
    "group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-orange-600":
      true,
    "dark:group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-orange-600":
      true,
    "dark:group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-orange-600":
      true,
    "dark:group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-orange-600":
      true,
  },
  transferlist__outer: {
    group: true,
  ...
  "multi-step__tab": {
    ...
    "group-data-[tab-style=tab]/wrapper:text-muted-foreground": true,
    ...
    "group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-orange-600":
      true,
    ...
    "dark:group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-orange-600":
      true,
  },
